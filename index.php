...
<head>
    ...
    <title>Pelayanan Surat Desa Durian Bungkuk</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php"><img src="main/img/db/tanahlaut.png" width="45" height="50" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="pegawai.php">Admin Login</a></li>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT<br> DESA DURIAN BUNGKUK</h2>
    ...
    <section id="contact">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3980.5254538156055!2d114.8672011139544!3d-3.9112920971551404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de6f8ce0fca584f%3A0xf74b963740c023a4!2sKantor%20Desa%20Durian%20Bungkuk!5e0!3m2!1sid!2sid!4v1662363663045!5m2!1sid!2sid" width="900" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> KANTOR DESA DURIAN BUNGKUK KECAMATAN BATU AMPAR KABUPATEN TANAH LAUT
                </div>
                <div class="col-sm-6">
