					...
					<div class="row mt-2">
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-danger">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Tempat Usaha</h6>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
									...
									<a href="?halaman=request_sktu" class="btn btn-danger btn-round btn-sm mb-3"><span class="btn-label">
										<i class="fas fa-plus-circle"></i> Request</a>
								</div>
						</div>
						<div class="col-md-3 pr-md-0">
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-secondary m-sm-2">
									<div class="pricing-header">
							...
							<div class="card card-stats card-round">
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												<p class="card-category">SKTU</p>
												<?php
													$sql = "SELECT * FROM data_request_sktu WHERE status=1";
													$query = mysqli_query($konek,$sql);
													$data = mysqli_fetch_array($query,MYSQLI_BOTH);
													$count = mysqli_num_rows($query);
													$status = $data['status'];
