...
<?php
	if(isset($_GET['id_request_sktu'])){
		$id_request_sktu=$_GET['id_request_sktu'];
		$sql = "SELECT * FROM data_request_sktu natural join data_user WHERE id_request_sktu='$id_request_sktu'";
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			...
			$ubah = "UPDATE data_request_sktu SET
		keterangan='$keterangan' WHERE id_request_sktu='$id_request_sktu'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_sktu">';
		  }
	}
?>