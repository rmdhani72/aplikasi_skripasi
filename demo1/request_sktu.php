						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">FORM TAMBAH REQUEST SURAT KETERANGAN TEMPAT USAHA</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['kirim'])){
	...
	$sql = "INSERT INTO data_request_sktu (nik,scan_ktp,scan_kk,usaha,keperluan) VALUES ('$nik','$file_ktp','$file_kk','$usaha','$keperluan')";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=request_sktu">';
	  }
}
