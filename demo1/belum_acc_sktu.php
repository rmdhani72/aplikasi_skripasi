						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<h4 class="fw-bold text-uppercase">belum acc request surat keterangan tempat usaha</h4>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													<?php
														$sql = "SELECT * FROM data_request_sktu natural join data_user where status=1";
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Surat" href="?halaman=view_sktu&id_request_sktu=<?= $id_request_sktu;?>">
    ...
    if(isset($_POST['acc'])){
        if(isset($_POST['check']))
        {
                    foreach ($_POST['check'] as $value){
                        // echo $value;
                        $ubah = "UPDATE data_request_sktu set status =2 where id_request_sktu = $value"; 
