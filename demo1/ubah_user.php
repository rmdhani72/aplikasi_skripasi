											...
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													...
													<select name="status_warga" class="form-control">
														...
														<option value="Kerja" <?php if($status_warga=="Bekerja") echo 'selected'?>>Bekerja</option>
														<option value="Belum Kerja" <?php if($status_warga=="Belum Kerja") echo 'selected'?>>Belum Kerja</option>
														<option value="Belum Kerja" <?php if($status_warga=="Menikah") echo 'selected'?>>Menikah</option>
													</select>
												</div>
												<div class="form-group">
                                                ...
                                                <div class="form-group">
													...
													<select name="hak_akses" class="form-control">
														...
														<option value="Lurah" <?php if($hak_akses=="Kepala Desa") echo 'selected'?>>Lurah</option>
											...
											<div class="col-md-6 col-lg-6">
                                                ...
                                                <div class="form-group">
													...
													<select name="hak_akses" class="form-control">
														...
														<option value="Pemohon" <?php if($hak_akses=="Pemohon") echo 'selected'?>>Pemohon</option>
														<option value="Kepala Desa" <?php if($hak_akses=="Kepala Desa") echo 'selected'?>>Kepala Desa</option>
														<option value="Staf" <?php if($hak_akses=="Staf") echo 'selected'?>>Staf</option>
													</select>
												</div>
											</div>
